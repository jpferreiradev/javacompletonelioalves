package CourseReview.OrientacaoObjetos.Construtores.Exemplo.application;

import CourseReview.OrientacaoObjetos.Construtores.Exemplo.entities.Produto;
...
public class Program {
    public static void main(String[] args) {
        ...
        Produto produto = new Produto(nome, preco, quantidadeStock);
